  ...
  public static class ThymeleafWebLayoutConfiguration {
    ...
    private static BeanInstanceSupplier<LayoutDialect> getLayoutDialectInstanceSupplier() {
      return BeanInstanceSupplier.<LayoutDialect>forFactoryMethod(ThymeleafAutoConfiguration.ThymeleafWebLayoutConfiguration.class, "layoutDialect")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.thymeleaf.autoconfigure.ThymeleafAutoConfiguration$ThymeleafWebLayoutConfiguration", ThymeleafAutoConfiguration.ThymeleafWebLayoutConfiguration.class).layoutDialect());
    }
    ...
    public static BeanDefinition getLayoutDialectBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.thymeleaf.autoconfigure.ThymeleafAutoConfiguration$ThymeleafWebLayoutConfiguration");
